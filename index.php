...
<html lang="en">
<head>
<title>Tour De Bangladesh</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Tour De <span>Bangladesh</span><p class="logo_w3l_agile_caption">Your Safe Journey</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#package" class="menu__link scroll">Package</a></li>
							<li class="menu__item"><a href="#about" class="menu__link scroll">About</a></li>
							<li class="menu__item"><a href="#services" class="menu__link scroll">Our Services</a></li>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>Tour De Bangladesh</h4>
									<h3>Your Safest Place.</h3>
...
HOT SUMMER OFFER 2023 !!               OFF 20% FOR Tour !!!                          
</marquee></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Tour De Bangladesh</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<!-- //team -->
	 ...
	 <!-- rooms & rates -->
      ...
      <div class="plans-section" id="package">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Saint Martin Package</h3>
				 
				 
				 <div style="text-align:center; font-size: 20px;">3 Night 2 Days Package</h4></div>
				 <div style="text-align:center; font-size: 20px;">Air-Conditioned buses</h4></div>

				 <div style="text-align:center; font-size: 20px;">Food Included</h4></div>
				 <div style="text-align:center; font-size: 20px;">Ship Fare Included</h4></div>
	 ...
	 <!--// rooms & rates -->
      ...
      <div class="plans-section" id="rooms" id="package">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Cox's Bazar</h3>

				 <div style="text-align:center; font-size: 20px;">4 Night 3 Days Package</h4></div>
				 <div style="text-align:center; font-size: 20px;">Air-Conditioned buses</h4></div>
	 ...
	 <!--// rooms & rates -->
      ...
      <div class="plans-section" id="rooms" id="package">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Sajek</h3>
...
<!-- /About Our Tour De Bangladesh -->

<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Tour De Bangladesh</h3> 
...
<style>
	...
	.w3layouts-banner-top1{
		background: url(images/cox.jpg);
		background-size: cover;	

	}
	.w3layouts-banner-top2{
		background: url(images/saint.jpg);
		background-size: cover;	
